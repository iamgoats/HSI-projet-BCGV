...
typedef struct {
    ...
    vitesse_t affichage_vitesse_; // Affichage vitesse 
...
int set_voyant_feux_de_position(app_data_t *data, voyant_t value);
voyant_t get_voyant_feux_de_croisement(const app_data_t *data);
int set_voyant_feux_de_croisement(app_data_t *data, voyant_t value);
voyant_t get_voyant_feux_de_route(const app_data_t *data);
int set_voyant_feux_de_route(app_data_t *data, voyant_t value);
voyant_t get_voyant_essence(const app_data_t *data);
int set_voyant_essence(app_data_t *data, voyant_t value);
voyant_t get_voyant_défaut_de_moteur(const app_data_t *data);
int set_voyant_défaut_de_moteur(app_data_t *data, voyant_t value);
voyant_t get_voyant_pression_de_pneu(const app_data_t *data);
int set_voyant_pression_de_pneu(app_data_t *data, voyant_t value);
voyant_t get_voyant_batterie_déchargée(const app_data_t *data);
int set_voyant_batterie_déchargée(app_data_t *data, voyant_t value);
voyant_t get_voyant_warnings(const app_data_t *data);
int set_voyant_warnings(app_data_t *data, voyant_t value);
voyant_t get_voyant_panne_batterie(const app_data_t *data);
int set_voyant_panne_batterie(app_data_t *data, voyant_t value);
voyant_t get_voyant_temp_ldr(const app_data_t *data);
int set_voyant_temp_ldr(app_data_t *data, voyant_t value);
voyant_t get_voyant_pession_moteur(const app_data_t *data);
int set_voyant_pession_moteur(app_data_t *data, voyant_t value);
voyant_t get_voyant_surchauffe_huile(const app_data_t *data);
int set_voyant_surchauffe_huile(app_data_t *data, voyant_t value);
voyant_t get_voyant_défallaince_freins(const app_data_t *data);
int set_voyant_défallaince_freins(app_data_t *data, voyant_t value);
commande_t get_activation_essuie_glaces(const app_data_t *data);
int set_activation_essuie_glaces(app_data_t *data, commande_t value);
commande_t get_activation_lave_glace(const app_data_t *data);
int set_activation_lave_glace(app_data_t *data, commande_t value);
km_t get_affichage_kilométrage(const app_data_t *data);
int set_affichage_kilométrage(app_data_t *data, km_t value);
vitesse_t get_affichage_vitesse_(const app_data_t *data);
int set_affichage_vitesse_(app_data_t *data, vitesse_t value);
reservoir_t get_affichage_niveau_réservoir(const app_data_t *data);
int set_affichage_niveau_réservoir(app_data_t *data, reservoir_t value);
trmin_t get_affichage_tours_minutes(const app_data_t *data);
int set_affichage_tours_minutes(app_data_t *data, trmin_t value);
commande_t get_cmd_warning(const app_data_t *data);
int set_cmd_warning(app_data_t *data, commande_t value);
commande_t get_cmd_feux_de_poition(const app_data_t *data);
int set_cmd_feux_de_poition(app_data_t *data, commande_t value);
commande_t get_cmd_feux_de_route(const app_data_t *data);
int set_cmd_feux_de_route(app_data_t *data, commande_t value);
commande_t get_cmd_clignotant_droit(const app_data_t *data);
int set_cmd_clignotant_droit(app_data_t *data, commande_t value);
commande_t get_cmd_clignotant_gauche(const app_data_t *data);
int set_cmd_clignotant_gauche(app_data_t *data, commande_t value);
